...
//yedi file null xaina vane image.file means device ko file bata image liyera dekhaune ano dotted border vitra fill hune gare select gareko photo dekhaune
                      ...
                      loginButton(context, "Save", () {
                        restaurantProductProvider.addProduct(context: context,
                          ...
                          onSuccess: (){
                            showDialog(
                              ...
                              builder: (BuildContext context) {
                                return AlertDialog(
                                  title: Center(child: Text("Produt added successfully")),
                                  content: Column(
                                  ...
                                  actions: <Widget>[
                                    TextButton(
                                      child: Text("Close"),
                                      onPressed: () {
                                        Navigator.push(context, MaterialPageRoute(builder: (context) => AddFood())); // Close dialog
                                      },
                                    ),
                                  ],
                                );
