        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              SizedBox(height: 15),
              reusableTextField("Search Food, Drink, etc", Icons.search_outlined, "search", searchTextController),
              SizedBox(
                height: 30,
              ),
              Container(
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          menuItem("Chicken", "assets/images/chickenfry.png"),
                          SizedBox(
                            width: 15,
                          ),
                      ...
                      Row(
                        children: [
                          ...
                          menuItem("Noodles", "assets/images/noodles.png"),
                          SizedBox(
                            width: 15,
                          ),
                        ...
                        SizedBox(
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) => Padding(
                              padding: const EdgeInsets.fromLTRB(0, 10, 10, 10), //2 ta box ko distance
                              child: Container(
                                height: 150,
                                width: 150,
                                decoration: BoxDecoration(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        children: [
                                          Text(productProvider.foodProductList[index].productName!,style:TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 16)),
                                        ],
                                      ),
                                    ),
                                    Padding(
                                      ...
                                      child: Row(
                                        children: [
                                          ...
                                          Text("Rs. " + productProvider.foodProductList[index].productPrice!,style:TextStyle(color: Colors.red,fontWeight: FontWeight.bold,fontSize: 16),),
                                        ],
                                      ),
                                    ),
                                  ],
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        children: [
                                          Text(data[index].name!,style:TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 16)),
                                        ],
                                      ),
                                    ),
                                    Padding(
                                      ...
                                      child: Row(
                                        children: [
                                          ...
                                          Text(data[index].price!,style:TextStyle(color: Colors.red,fontWeight: FontWeight.bold,fontSize: 16),),
                                        ],
                                      ),
                                    ),
                                  ],
